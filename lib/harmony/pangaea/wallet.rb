  ...
  module Pangaea
    class Wallet
      ...
      class << self
        ...
        def send(from_address:, from_shard:, to_address:, to_shard:, amount: nil, wallet_script: ::Harmony::Pangaea.configuration.wallet_script, binary: :cross_shard, input_data: nil, daemonize: false)
